...
RUN echo 'export PS1="\e[32m\u\e[0m \e[96m\w\e[0m > \e[31m\$(git rev-parse --abbrev-ref HEAD)\e[0m:\e[33m\$(git describe --tags $(git rev-list --tags --max-count=1))\e[0m \$ "'  >> ~/.bashrc
